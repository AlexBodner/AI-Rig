...
Parts:
  ...
  2  inviscid front diagnostics: transit-time ratio and front amplitude slope (K41 vs front regime)
...
SLOPE_FRONT = -0.5  # predicted log2 front amplitude slope, front cascade
